     	...
     	<div class="container_12">
        	...
        	<div id="smoothmenu1" class="ddsmoothmenu" style="padding-top:20px; padding-left:100px">
				 <ul>
					...
					<li class="bar"><a  href="http://www.dynamicdrive.com">Folder 0</a>
					  <ul>
						  <li><div style="padding-top:10px; padding-left: 5px; padding-bottom: 10px;">asfasfsd</div></li>
						  <li><div style="padding-top:10px; padding-left: 5px; padding-bottom: 10px;">sfasadf</div></li>
				...
				<li class="bar">
					<a  href="http://www.dynamicdrive.com">Folder 1</a>
				  <ul>
				...
				<li class="bar"><a href="http://www.dynamicdrive.com">Folder 2</a>
				  <ul>
