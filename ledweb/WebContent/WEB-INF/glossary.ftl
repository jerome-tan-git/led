  ...
  <div class="col-lg-8">
	<div class="well">
    	...
    	<div class="col-lg-10">
	    	...
	    	<h3 class="panel-title">LED Glossary Page</h3>
	  </div>
    
	

	    <div class="form-group">
	      <label for="exampleInputPassword">Glossary</label>
	      
	      <textarea class="form-control" id="editor1" rows="5" name="article" placeholder="Glossary Article">
	      	${(glossary.article)!""}
	      </textarea>
	    </div>
